...
export function TripHistoryView({ onBack }: TripHistoryViewProps) {
  ...
  const tripHistory = [
    {
      ...
      boardingLocation: "Dagenham Heathway (RM10 9QB)",
      arrivalTime: "07:55 AM",
      arrivalLocation: "UEL Docklands Campus (E16 2RD)",
      status: "completed",
    },
    {
      id: 2,
      ...
      boardingLocation: "UEL Docklands Campus (E16 2RD)",
      arrivalTime: "04:40 PM",
      arrivalLocation: "Dagenham Heathway (RM10 9QB)",
      status: "completed",
    },
    {
      id: 3,
  ...
  // Filter trip history based on search, route, and date range
  const filteredTrips = tripHistory.filter((trip) => {
    ...
    return matchesSearch && matchesRoute && isAfterStartDate && isBeforeEndDate
  })
