  ...
  const notifications = [
    {
      ...
      message: "Your children have arrived at UEL Docklands Campus.",
      time: "08:30 AM",
      date: "Today",
      isRead: false,
    },
    ...
    },
    {
      ...
      message: "Alex and Emma Thompson have boarded Bus #103.",
      time: "07:30 AM",
      date: "Today",
      isRead: true,
    },
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <Label htmlFor="bus-arrival" className="flex flex-col gap-1">
                        ...
                        <span className="font-normal text-sm text-muted-foreground">
                          Receive notifications when the bus arrives at school or home
                        </span>
                      </Label>
                      <Switch
                        id="bus-arrival"
                    ...
                    <div className="flex items-center justify-between">
                      <Label htmlFor="check-in-out" className="flex flex-col gap-1">
                        ...
                        <span className="font-normal text-sm text-muted-foreground">
                          Receive notifications when your children board or exit the bus
                        </span>
                      </Label>
                      <Switch
                        id="check-in-out"
